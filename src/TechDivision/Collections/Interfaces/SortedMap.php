 ...
 * @license GPL
 */
interface TechDivision_Collections_Interfaces_SortedMap
    extends TechDivision_Collections_Interfaces_Map {

    /**
     * This method returns the comparator passed
     * with the constructor.
     *
     * @return TechDivision_Collections_Interfaces_Comparator Holds the comparator passed with the constructor
     */
